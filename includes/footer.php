  ...
  <div class="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
    ...
    <div>
      <div class="flex items-center gap-3 mb-8">
        <div>
          <h4 class="text-lg font-bold leading-none tracking-tight text-white">MAQUINADOS </h4>
...
<a class="w-10 h-10 bg-navy-blue flex items-center justify-center hover:bg-[#25D366] transition-all rounded-sm"
 href="https://wa.me/523331576129?text=Hola,%20me%20gustar%C3%ADa%20solicitar%20una%20cotizaci%C3%B3n"
target="_blank"
   aria-label="WhatsApp">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-5 h-5 fill-white">
  ...
  <a class="w-10 h-10 bg-navy-blue flex items-center justify-center hover:bg-[#1877F2] transition-all rounded-sm"
     href="https://www.facebook.com/profile.php?id=61558371863303&locale=es_LA"
     target="_blank">
    ...
    <!-- NAVEGACIÓN -->
    <div>
      <h5 class="text-white font-bold uppercase tracking-widest text-xs mb-8 border-b border-primary-red pb-2 inline-block">
        Navegación
      </h5>
      <ul class="space-y-4">
  ...
  <li><a class="text-gray-400 hover:text-primary-red transition-colors text-sm uppercase font-bold tracking-wider" href="maquinaria.php">Maquinaria</a></li>
    ...
    <div class="lg:col-span-2">
      ...
      <div class="grid md:grid-cols-2 gap-8 mb-8">
        <div class="flex items-start gap-4">
          <span class="material-symbols-outlined text-primary-red">location_on</span>
          <div>
            <p class="text-white font-bold text-sm uppercase tracking-wider mb-2">Planta Matriz</p>
            <p class="text-gray-400 text-sm leading-relaxed">
              20 de Noviembre No.361,<br/>
              Col. Analco, CP 44450,<br/>
        ...
        <div class="flex items-start gap-4">
          <span class="material-symbols-outlined text-primary-red">contact_phone</span>
          <div>
            <p class="text-white font-bold text-sm uppercase tracking-wider mb-2">Línea Industrial</p>
            <p class="text-gray-400 text-sm leading-relaxed">
              01 (33) 3617-5426<br/>
              contacto@maquinadosyservicios
              industriales.com
            </p>
          </div>
        </div>
