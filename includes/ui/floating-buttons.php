...
<div id="floatingButtons" class="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[9999] flex flex-col gap-2 sm:gap-3">
  ...
  <a
    ...
    target="_blank"
    class="group flex items-center gap-2 sm:gap-3 bg-[#25D366] hover:bg-[#1ebe5d]
       px-3 py-3 sm:px-5 sm:py-3 rounded-md shadow-xl shadow-green-900/40
       transition-all">
    ...
    <span class="hidden sm:inline text-xs font-black uppercase tracking-widest text-white">WhatsApp</span>
  </a>

  <!-- Cotización -->
  <a
    href="contacto.php"
 class="group flex items-center gap-2 sm:gap-3 bg-primary-red hover:bg-red-700
       px-3 py-3 sm:px-5 sm:py-3 rounded-md shadow-xl shadow-red-900/30 transition-all
       animate-float-delayed">

<span class="material-symbols-outlined text-white text-lg sm:text-xl group-hover:scale-110 transition-transform">
  mail
</span>
