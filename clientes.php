...
<section class="relative h-[60vh] flex items-center overflow-hidden bg-deep-black">
  ...
  <div class="absolute inset-0 z-0">
    ...
    <!-- Oscurecido elegante (no mata la imagen) -->
  ...
  <!-- CONTENIDO -->
  <div class="reveal zoom-text relative max-w-7xl mx-auto px-8 md:px-12 w-full z-10">
    <div class="max-w-3xl">
...
<section class="bg-white border-b border-gray-100 py-12 relative z-10 shadow-sm">
  <div class="reveal zoom-text max-w-7xl mx-auto px-8 md:px-12">
