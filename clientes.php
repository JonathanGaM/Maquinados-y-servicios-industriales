...
<section class="bg-white border-b border-gray-100 py-10 sm:py-12 relative z-10 shadow-sm">
  <div class="max-w-7xl mx-auto px-5 sm:px-8 md:px-12">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center text-center md:text-left">
...
<!-- CTA -->
<section class="py-20 sm:py-24 bg-navy-blue text-white overflow-hidden relative">
  <div class="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 text-center relative z-10">
    ...
    <p class="text-base sm:text-lg md:text-xl text-gray-400 mb-10 sm:mb-12 max-w-2xl mx-auto font-light leading-relaxed">
    ...
    <div class="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6">
      ...
      <a href="contacto.php"
        class="w-full md:w-auto border border-white/20 hover:bg-white hover:text-navy-blue text-white px-10 sm:px-12 py-3.5 sm:py-4 text-sm font-black uppercase tracking-widest transition-all text-center">
        Contáctanos
      </a>
    </div>
  </div>
