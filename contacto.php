...
<main class="relative min-h-[calc(100vh-89px)] flex items-center overflow-hidden">
  <!-- FONDO -->
  <div class="absolute inset-0 z-0">
    <img
      alt="Industrial Background"
      class="parallax-bg absolute inset-0 w-full h-full object-cover scale-110 opacity-100 saturate-0 brightness-[0.35]"
      src="https://cncsur.cl/wp-content/uploads/2018/11/DSC_01652.jpg"
    />
<div class="absolute inset-0 bg-gradient-to-b from-navy-blue/80 to-deep-black/95"></div>
  ...
  <!-- CONTENIDO -->
  <div class="relative z-10 max-w-7xl mx-auto px-8 md:px-12 py-20 w-full">
  ...
  HABLEMOS DE <br/><span class="text-primary-red">SU PROYECTO</span>
          ...
          <p class="text-lg text-gray-300 leading-relaxed font-light max-w-md">
        ...
        <div class="space-y-8">
          ...
          <div class="flex items-start gap-6">
            ...
            <div>
              ...
              <p class="text-gray-200 text-sm leading-relaxed">contacto@maquinadosyserviciosindustriales.com</p>
            </div>
          </div>

          <div class="pt-6 border-t border-white/10">
            <div class="flex items-center gap-3">
              <span class="material-symbols-outlined text-primary-red text-sm">schedule</span>
              <span class="text-gray-400 text-[11px] font-bold uppercase tracking-widest">
                Horario de Atención: Lunes a Sábado, 9:00 AM - 6:30 PM
              </span>
            </div>
          </div>
        </div>
  ...
  <div class="glass-morphism p-10 md:p-14 rounded-sm shadow-2xl relative overflow-hidden">
