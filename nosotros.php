...
include_once "includes/db-safe.php";
include_once "includes/fallbacks.php";
...
<div class="bg-navy-blue text-white">
    ...
    <div class="flex flex-col lg:flex-row w-full min-h-[80vh]">
      ...
      <div class="w-full lg:w-1/2 relative h-96 lg:h-auto overflow-hidden">
        ...
        <div class="absolute bottom-20 left-10 right-10 md:bottom-24 md:left-12 md:right-12">
          <div class="reveal from-left bg-primary-red/90 backdrop-blur-md p-5 inline-block rounded-sm">
      ...
      <!-- TEXTO -->
      <div class="reveal from-right w-full lg:w-1/2 bg-navy-blue px-10 py-14 md:px-12 md:py-16 lg:px-20 lg:py-20 flex flex-col justify-center">
  ...
  <section class="py-16 bg-navy-blue border-b border-white/10">
    <div class="max-w-7xl mx-auto px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-12">
      ...
      <div class="reveal flex items-center gap-6 bg-deep-black/50 border border-white/10 py-6 px-10 rounded-sm">
  ...
  <section class="relative py-28 bg-white overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-12 grid lg:grid-cols-2 gap-20 z-10">
      ...
      <article class="reveal from-left relative bg-white border border-border-navy/20 p-16 rounded-sm shadow-2xl">
        ...
        <!-- ✅ corregido -->
        <h3 class="text-4xl md:text-5xl font-black uppercase text-navy-blue mb-8 leading-tight">
          Misión
        </h3>
